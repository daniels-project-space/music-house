    ...
    return Promise.all(
      rows.map(async (r) => {
        ...
        return {
          ...
          karaokeVideoKey: r.karaokeVideoKey ?? null,
          karaokeStatus: r.karaokeStatus ?? null,
          karaokeProgress: r.karaokeProgress ?? null,
          karaokeYoutubeUrl: r.karaokeYoutubeUrl ?? null,
